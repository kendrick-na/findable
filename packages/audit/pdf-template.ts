...
function sentimentBadge(sentiment: string | null): string {
  if (sentiment === "positive") {
    return `<span class="badge badge-positive">긍정</span>`;
  }
  if (sentiment === "negative") {
    return `<span class="badge badge-negative">부정</span>`;
  }
...
<div class="section">
  ...
  <table>
    ...
    <tbody>
      ${dedupeByEngine(data.engineResponses)
        .map(
          (r) => `
        <tr>
